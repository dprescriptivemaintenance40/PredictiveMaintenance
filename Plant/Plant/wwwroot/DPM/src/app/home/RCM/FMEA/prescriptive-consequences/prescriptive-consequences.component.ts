...
export class PrescriptiveConsequencesComponent implements OnInit, CanComponentDeactivate {
 displayModal: boolean;
  ...
  SubmitConsequenceTree() {
    ...
    this.RCMOBJ.RCMId = this.ConsequencesData.RCMId;
    this.RCMOBJ.FMWithConsequenceTree = JSON.stringify(this.data1);
    for (let index = 0; index < this.FMTree.length; index++) {
      let obj = {};
      obj['FailureModeId'] = this.ConsequencesData.failureModes[index].FailureModeId;
      obj['RCMId'] = this.ConsequencesData.failureModes[index].RCMId;
      obj['FailureMode'] = this.FMTree[index].data.name;
      ...
      obj['DownTimeFactor'] = this.ConsequencesData.failureModes[index].DownTimeFactor;
      obj['ScrapeFactor'] =   this.ConsequencesData.failureModes[index].ScrapeFactor;
      obj['SafetyFactor'] =   this.ConsequencesData.failureModes[index].SafetyFactor;
      obj['ProtectionFactor'] = this.ConsequencesData.failureModes[index].ProtectionFactor;
      obj['FrequencyFactor'] =  this.ConsequencesData.failureModes[index].FrequencyFactor;
      obj['CriticalityFactor'] =this.ConsequencesData.failureModes[index].CriticalityFactor;
      obj['Rating'] = this.ConsequencesData.failureModes[index].Rating;
      obj['MaintainenancePractice'] =  this.ConsequencesData.failureModes[index].MaintainenancePractice;
      obj['FrequencyMaintainenance'] = this.ConsequencesData.failureModes[index].FrequencyMaintainenance;
      obj['ConditionMonitoring'] = this.ConsequencesData.failureModes[index].ConditionMonitoring;
      obj['AttachmentDBPath'] =    this.ConsequencesData.failureModes[index].AttachmentDBPath
      obj['AttachmentFullPath'] =  this.ConsequencesData.failureModes[index].AttachmentFullPath
      obj['Remark'] = this.ConsequencesData.failureModes[index].Remark
