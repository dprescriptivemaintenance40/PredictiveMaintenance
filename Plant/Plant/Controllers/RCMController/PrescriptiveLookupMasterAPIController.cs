...
namespace DPM.Controllers.Prescriptive
{
    ...
    public class PrescriptiveLookupMasterAPIController : ControllerBase
    {
        ...
        public PrescriptiveLookupMasterAPIController(PlantDBContext context)
        {
            _context = context;
        }
        ...
        {
            var lookupMasterModel = await _context.PrescriptiveLookupMassterModelData.Where(a => a.EquipmentType == data)
                                                                                     .OrderBy(a => a.PrescriptiveLookupMasterId)
                                                                                     .ToListAsync();
